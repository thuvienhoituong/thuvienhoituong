(function (h, e) {
  ...
  function S(a) {
    this.constraints = Object.assign(
      { video: { width: { ideal: 1920 }, height: { ideal: 1080 }, facingMode: { exact: 'environment' } }, audio: !1 },
      a,
    );
    ...
    function k(a) {
      if (!1 !== f.enabled && !0 !== f.noZoom && x === w.NONE) {
        ...
        0 < d
          ...
          : 0 > d &&
            ((f.object.fov = f.object.fov > f.minFov ? f.object.fov - 1 : f.minFov), f.object.updateProjectionMatrix());
        f.update();
        f.dispatchEvent(V);
        f.dispatchEvent(O);
        f.dispatchEvent(P);
  ...
  function da(a) {
    ...
    this.camera =
      a.camera ||
      new e.PerspectiveCamera(this.options.cameraFov, this.container.clientWidth / this.container.clientHeight, 1, 1e4);
  ...
  M.prototype = Object.assign(Object.create(e.Sprite.prototype), {
    ...
    updateCanvasArcByProgress: function (a) {
      ...
      0 === a
        ...
        : (b.arc(l, k, c / 4 - 3, -Math.PI / 2, -Math.PI / 2 + e), (b.strokeStyle = m), (b.lineWidth = 3), b.stroke());
      b.closePath();
      g.map.needsUpdate = !0;
    },
    ripple: function () {
    ...
    update: function () {
      ...
      1 <= a &&
        (window.cancelAnimationFrame(this.timerId), this.callback && this.callback(), this.end(), this.ripple());
    },
  });
  var r = (function (a, b) {
        ...
        for (b in this._valuesEnd)
          if (void 0 !== this._valuesStart[b]) {
            ...
            l instanceof Array
              ...
              : ('string' === typeof l &&
                  (l = '+' === l.charAt(0) || '-' === l.charAt(0) ? e + parseFloat(l) : parseFloat(l)),
  ...
  I.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
    ...
    addControlBar: function () {
      if (this.container) {
        ...
        d.dispose = function () {
          a.fullscreenElement &&
            (d.removeChild(a.fullscreenElement), a.fullscreenElement.dispose(), (a.fullscreenElement = null));
    ...
    createFullscreenButton: function () {
      function a() {
        d &&
          ((c = !c),
          (e.style.backgroundImage = c ? 'url("' + u.FullscreenLeave + '")' : 'url("' + u.FullscreenEnter + '")'));
    ...
    createSubMenu: function (a, b) {
      function c(a) {
        ...
        k.hide();
        'header' !== this.type &&
          (k.setActiveItem(this), d.activeMainItem.setSelectionTitle(this.textContent), this.handler && this.handler());
      }
      var d = this,
        e,
        k = this.createMenu();
  ...
  Object.assign(P.prototype, {
    ...
    progress: function () {
      ...
      if (
        ...
        ((this.canvas = this._canvas), (this.panoId = this._panoId), (this.zoom = this._zoom), this.onPanoramaLoad)
      )
        ...
        if (
          ...
          (a =
            a.changedTouches && 1 === a.changedTouches.length
              ? this.onTap({ clientX: a.changedTouches[0].clientX, clientY: a.changedTouches[0].clientY }, b)
              : this.onTap(a, b)),
      ...
      if (this.panorama) {
        ...
        if ('click' === b)
          ...
          d &&
            ...
            (this.hoverObject !== d &&
              ...
              this.hoverObject.dispatchEvent &&
                ...
                ((this.options.autoReticleSelect && this.options.enableReticle) || this.tempEnableReticle) &&
            ...
            'mousedown' === this.userMouse.type &&
              this.pressObject != e &&
              ((this.pressObject = e),
              this.pressObject.dispatchEvent && this.pressObject.dispatchEvent({ type: 'pressstart', mouseEvent: a })),
          ...
          !e &&
            this.pressObject &&
            this.pressObject.dispatchEvent &&
            (this.pressObject.dispatchEvent({ type: 'pressstop', mouseEvent: a }), (this.pressObject = void 0));
        }
        if (e && e instanceof z) {
